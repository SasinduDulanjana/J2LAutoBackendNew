...
public class CustomerController {
    ...
    public ResponseEntity<CommonResponse> getCustomerByPhone(@PathVariable String mobileNo) {
    ...
    public ResponseEntity<CommonResponse> getCustomerById(@PathVariable Integer id) {
